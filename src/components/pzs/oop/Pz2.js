...
const HINTS = [
  {
    title: 'Hint One',
    body: 'You can only add and remove your pieces to the grid. And only the most recent piece added can be removed.'
  },
  {
    title: 'Hint Two',
    body: 'The solutions are on the wall art.  Remember to work together if playing as a team, try experimenting. Add a piece, if it doesnt match, remove it.'
  }
]
